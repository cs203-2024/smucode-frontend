...
import {
  ...
  PlaneIcon,
  GiftIcon,
} from "@/components/IconsHowItWorks";
...
const features: FeatureProps[] = [
  ...
  },
  {
    ...
    title: "Community",
    description:
      "Admins create tournaments, while participants join and compete. BrawlCode fosters a collaborative and competitive community.",
  },
  {
    icon: <PlaneIcon />,
    title: "Scalability",
